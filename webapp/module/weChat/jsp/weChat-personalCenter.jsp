...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/module/weChat/others/css/common_pc.css?v=20150718">
    ...
    <![endif]-->
<link rel="stylesheet" type="text/css" href="${path}/module/weChat/others/css/m-index.css?v=20150718">
</head>
<body>
<script>
window.op = window.op || {};
...
seajs.use('http://statics.oneplus.cn/v2/js/g/top-head.js',function(topHead){
    topHead.init({});
			 ...
			 <div class="user-hd">
			    <div class="my-avatar">
			        <a href="#填写个人修改头像地址">
			        		<img src="${employee.headimgurl }" alt="">
			            <span class="update-tip"><i class="i-update-avatar"></i></span>
			        </a>
			    </div>                
			    <div class="my-nickname">
			        <span>
           				 ${employee.name }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${employee.wxCpUser.position}
			        </span>
			    </div>    
			    <ul class="my-stuffs">
			        <li>
			            <a href="javascript:void(0);">
			                <span class="my-point">${employee.baseBitcoin }</span>
			                <em>每月基础币</em>
			            </a>
			        </li>
			        <li>
			            <a href="javascript:void(0);">
			                <span class="my-point">${employee.bitcoinIncome }</span>
			                <em>本月收入币</em>
			            </a>
			        </li>
			        <li>
			            <!-- 已绑定时显示 -->
			             <a href="javascript:void(0);">
			                <span>${employee.bitcoinConsume }</span>
			                <em>本月消耗币</em>
			            </a>
			        </li>
			        <li>
			            <a href="javascript:void(0);">
			                <span>${employee.bitcoinSurplus }</span>
			                <em>当前余额</em>
			            </a>
			        </li>
			    </ul>
            ...
            <div class="user-bd">
				<div class="user-aside">
				    <dl class="user-menu">
				        <dt>我的任务</dt>
				        <dd><a href="${path }/weChat/myPublishedTask?employeeId=${employee.id}"><i class="i-my-order"></i>已发布任务</a></dd>
				        <dd><a href="${path }/weChat/myReceivedTask?employeeId=${employee.id}"><i class="i-my-address"></i>已接受任务</a></dd>
				        <dd><a href="${path }/weChat/myFinishedTask?employeeId=${employee.id}"><i class="i-my-prize"></i>已完成任务</a></dd>
				        <dd><a href="${path }/weChat/msgList?employeeId=${employee.id}"><i class="i-my-cunpon"></i>待处理任务</a></dd>
				        <dd><a href="${path }/weChat/publishTask?employeeId=${employee.id}"><i class="i-my-prize"></i>发布任务</a></dd>
				    </dl>
				    <dl class="user-menu">
				        <dt>评价管理</dt>
				        <dd><a href="${path }/weChat/evaluationList?employeeId=${employee.id}"><i class="i-my-account"></i>我的评价</a></dd>
				    </dl>
				</div> 
<footer class="op-footer clearfix" id="op-footer">
	<div class="op-footer-kf">
		<p class="op-telhot"><i class="i-ft-tel"></i><span>客服热线：</span>0472-5198570</p> 
	</div>
	...
	<div class="op-copyright">
		<p>Copyright&copy;<a href="http://www.lanrenmb.com/" target="_blank">云图科技</a>(2013-2015) 版权所有
</p>
	</div>
</footer>
 <script>
